...
const Index = () => {
  ...
  return (
    <div className="h-[100dvh] w-full flex flex-col buddy-gradient-bg space-stars overflow-hidden safe-area-inset relative">
      {/* Layer 1: Buddy as fixed background character */}
      <div
        className="absolute inset-0 z-0 flex items-center justify-center pointer-events-none transition-opacity duration-1000 ease-in-out"
        style={{ opacity: hasConversation ? 0.2 : 0.85 }}
      >
      ...
      <div className="relative z-10 flex flex-col h-full">
        ...
        {/* Chat area - scrollable, glass overlay */}
        <div className="flex-1 min-h-0 relative">
          ...
          <div
            ...
            style={{
              ...
              background: 'linear-gradient(to bottom, hsl(var(--background) / 0.3) 0%, hsl(var(--background) / 0.6) 30%, hsl(var(--background) / 0.75) 100%)',
              backdropFilter: hasConversation ? 'blur(8px)' : 'blur(0px)',
            }}
          />

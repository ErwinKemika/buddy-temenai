...
const TodoPage = () => {
  ...
  return (
    <div className="h-[100dvh] w-full flex flex-col buddy-gradient-bg space-stars overflow-hidden safe-area-inset">
      {/* Mini Buddy header */}
      <header className="relative px-4 pt-3 pb-2 bg-card/40 backdrop-blur-md border-b border-border/30 safe-top">
        <div className="flex items-center gap-3">
          {/* Mini Buddy Robot */}
          <div className="relative shrink-0 animate-float" style={{ animationDuration: '3s' }}>
            {/* Glow */}
            <div className="absolute inset-0 w-11 h-11 rounded-full bg-primary/15 blur-md" />
